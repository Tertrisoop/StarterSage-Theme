          ...
          <div class="news__info">
            ...
            <div class="news__info-date">
              <span class="td-post-date">
                <time class="entry-date" datetime="">April 8, 2020</time>
              </span>
            </div>
      ...
      <div class="news__info">
        ...
        <div class="col-md-3">
          ...
          <div class="media news__category-pos">
            ...
            <img src="@php echo get_stylesheet_directory_uri() @endphp/assets/images/p1.jpg"  class="ml-1 news__img" alt="Generic placeholder image">
          </div>
           <!-- post 2 -->
          <div class="media news__category-pos">
            <div class="media-body">
      ...
      <div class="row">
        <div class="col-md-3">
          <a href="#" class="prevention__img">
              <img src="@php echo get_stylesheet_directory_uri() @endphp/assets/images/recl2.jpg" class="prevention__img" alt="G">
          </a>
        </div>
        {{-- <div class="col-md-6">
  ...
  <section class="global">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <a href="#" class="prevention__img">
              <img class="prevention__img" src="@php echo get_stylesheet_directory_uri() @endphp/assets/images/recl2.jpg" alt="" title="">
          </a>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-12">
          <div class="fotorama">
            <a href="https://www.youtube.com/watch?v=8RWT0YY5zRc" data-img="desert-rose.jpg">
              <img src="@php echo get_stylesheet_directory_uri() @endphp/assets/images/maxresdefault.webp" alt="" title="">
            </a>
            <a href="https://www.youtube.com/watch?v=8RWT0YY5zRc" data-img="desert-rose.jpg">
              <img src="@php echo get_stylesheet_directory_uri() @endphp/assets/images/maxresdefault.webp" alt="" title="">
            </a>
